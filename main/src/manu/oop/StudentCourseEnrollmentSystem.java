...
// ════════════════════════════════════════════════════════════
// DIALOG 3 — EnrollDialog
// Lets cashier/officer enroll a student into a course.
// If course is FULL → offers to join waitlist.
// ════════════════════════════════════════════════════════════
    ...
    class EnrollDialog extends Dialog implements ActionListener {
        ...
        private void buildUI() {
            ...
            waitlistBtn.setEnabled(false); // only enabled when course is FULL
...
// ════════════════════════════════════════════════════════════
// MAIN WINDOW — EnrollmentApp
// 3 tabs: COURSES | STUDENTS | ENROLLMENTS
// ════════════════════════════════════════════════════════════
    ...
    class EnrollmentApp extends Frame implements ActionListener {
        ...
        private void doDropCourseForStudent() {
            ...
            // Collect active enrollments for this student
